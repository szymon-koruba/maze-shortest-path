...
class MainScreen(GridLayout):
    ...
    def buttons(self):
        ...
        btn_start = Button(size_hint=(None, None), size=(442, 220),background_normal='button_start.png', background_down='button_start_down.png',
                           pos_hint={'center_x': 0.5, 'center_y': 0.6})
        btn_start.bind()

        btn_settings = Button(size_hint=(None, None), size=(442, 220), background_normal='button_settings.png', background_down='button_settings_down.png',
                              pos_hint={'center_x': 0.5, 'center_y': 0.4})
        btn_settings.bind()

        btn_guide = Button(size_hint=(None, None), size=(442, 220), background_normal='button_guide.png', background_down='button_guide_down.png',
                           pos_hint={'center_x': 0.5, 'center_y': 0.2})
        btn_guide.bind(on_press= Clock.create_trigger(self.show_guide_screen, timeout=0.2))

        btn_exit = Button(size_hint=(None, None), size=(242, 120), background_normal='button_exit.png', background_down='button_exit_down.png',
